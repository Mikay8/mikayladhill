    ...
    <header className="hero wrap" id="hero">
      ...
      <div className="hero-top">
        <div className="viewer" data-reveal>
          ...
          <div className="pic">
            <img src="/assets/mikayla.jpeg" alt="Mikayla D. Hill" />
          </div>
          <div className="foot">
        ...
        <div className="term" data-reveal>
          ...
          <div className="body">
            ...
            <span className="ln pd">→ Mikayla D. Hill · Software Engineer II</span>
      ...
      <div className="hero-meta" data-reveal>
        ...
        <span className="chip amber"><i className="dot" /> Jersey City, NJ</span>
        <span className="chip purple"><i className="dot" /> MS CS @ Georgia Tech</span>
      </div>

      {/* Row 3: name */}
      <h1 data-reveal>
        Mikayla D. <span className="stripe">Hill.</span>
      </h1>
      ...
      <p className="tagline" data-reveal>
        ...
        Currently working through an MS in CS at Georgia&nbsp;Tech, building things
        with yarn in my lap and a book on my chest.
      </p>

      {/* Row 5: stat strip */}
      <div className="stat-strip" data-reveal>
        <div><b>1,000+</b><span>platform users</span></div>
        <div><b>10+ hrs</b><span>weekly time saved @ bbg</span></div>
        <div><b>300+</b><span>students taught @ UF</span></div>
        <div><b>2</b><span>side projects shipping</span></div>
      </div>
    </header>
  );
}
